...
import { ComplectType, ConsaltingType, ContractType, FieldType, LegalTechType, RegionType, SupplyType } from "../../types/types";
...
export const googleAPI = {
    async get(token = null) {
        ...
        try {
            const res = await api.get<FieldsDataType & ComplectsDataType &
                SuppliesDataType & RegionsDataType &
                ConsaltingDataType & LegalTechDataType &
                ContractsDataType>(`${googleToken}/exec`);
