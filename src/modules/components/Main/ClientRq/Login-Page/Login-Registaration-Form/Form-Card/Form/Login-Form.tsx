...
import { FieldValidatorType, emailValidate, passwordValidate, requiredFields } from '../../../../../../../utils/Validators/validator'
    ...
    return (<>
        ...
        <form onSubmit={props.handleSubmit} className={style.inputs__container}>
            ...
            <div className={style.button__container}>
                ...
                {/* <Button disabled={false} onClick={undefined} color={'blue'} border={12} name={'НАЖАТЬ'} /> */}
                {/* </NavLink> */}
            </div>
