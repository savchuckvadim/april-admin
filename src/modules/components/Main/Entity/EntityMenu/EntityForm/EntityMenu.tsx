...
import { ClientFields, ClientSectionEnum } from "./EntityForm"
...
const EntityMenu: React.FC<ClientMenuPropsType> = ({ section, client, isChanged, isNew, touched, errors, handleChange, setClientName, updateField, updateClientProducts, getProducts }) => {
